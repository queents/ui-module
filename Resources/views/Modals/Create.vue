...
const rowFilterCreate = computed(()=>{
    let rows = props.rows;
    let rowValue = [];
...
function changeTab(selectedTab) {
    ...
    for (let i = 0; i < props.type.tabs.length; i++) {
        if (props.type.tabs[i].key === selectedTab.tab.computedId) {
            index.status = i;
        }
    }
    if (index.status === props.type.tabs.length - 1) {
        lastTab.value = true;
    } else {
        lastTab.value  = false;
    }
...
function nextTab() {
    index.props += 1;
    tabs.value.selectTab("#" + props.type.tabs[index.value].key);
}
            ...
            <div v-if="props.type.name === 'modal'">
                ...
                >
                    ...
                    >
                        ...
                        <ViltHasOne v-if="item.vue === 'ViltHasOne.vue' && item.create" :message="form.errors[item.name]" :row="item" v-model="form[item.name]"/>
                ...
                >
                    ...
                    >
                        ...
                        <ViltHasOne v-if="item.vue === 'ViltHasOne.vue' && item.edit" :message="form.errors[item.name]" :row="item" v-model="form[item.name]"/>
                    </div>
                    <slot name="edit"></slot>
                </form>
            </div>
            <div v-else-if="props.type.name === 'tabs'">
                ...
                >
                    ...
                    >
                        ...
                        <ViltHasOne v-if="item.vue === 'ViltHasOne.vue' && item.create && item.tab === null" :message="form.errors[item.name]" :row="item" v-model="form[item.name]"/>
                    </div>
                    <slot name="create"></slot>
                </form>
                <form class="grid grid-cols-1 md:grid-cols-1" action="" v-else>
                    ...
                    >
                        ...
                        <ViltHasOne v-if="item.vue === 'ViltHasOne.vue' && item.edit && item.tab === null" :message="form.errors[item.name]" :row="item" v-model="form[item.name]"/>
                    </div>
                    <slot name="edit"></slot>
                </form>
                <Tabs
                    ...
                    >
                        ...
                        >
                            ...
                            >
                                ...
                                <ViltHasOne v-if="item.vue === 'ViltHasOne.vue' && item.create && item.tab === tab.key" :message="form.errors[item.name]" :row="item" v-model="form[item.name]"/>
                            </div>
                            <slot name="create"></slot>
                        </form>
                        <form
                        ...
                        >
                            ...
                            >
                                ...
                                <ViltHasOne v-if="item.vue === 'ViltHasOne.vue' && item.edit && item.tab === tab.key" :message="form.errors[item.name]" :row="item" v-model="form[item.name]"/>
                            </div>
                            <slot name="edit"></slot>
                        </form>
                    </Tab>
