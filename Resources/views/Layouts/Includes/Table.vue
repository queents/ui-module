...
<template>
    <div v-if="table.name === 'table'">
        ...
        <div class="relative p-8 text-center" v-else>
            <div
                class="inline-flex items-center my-4 justify-center w-16 h-16 rounded-full bg-warning-300 dark:bg-dark_bg"
            >
                <i class="bx bxl-dropbox bx-md text-warning-600"></i>
            </div>
